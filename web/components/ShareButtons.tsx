    ...
    >
      ...
      {instagramReelUrl ? (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Otwórz na Instagramie"
        >
          <InstagramIcon />
          Instagram
        </a>
      ...
      <a
        ...
        href={
          tiktokUrl
            ? tiktokUrl
            : `https://www.tiktok.com/share?url=${encoded}&text=${encodedTitle}`
        }
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Udostępnij na TikToku"
      >
        <TikTokIcon />
        TikTok
      </a>
